...
def preprocess(text):
    custom_stop_words = ['Tell', 'Tell us', 'Narrated', 'Messenger', 'And' 'Prophet', 'Allah', 'God', 'Lord', 'Allaah', 'He',
                         'She', 'A', 'They', '(h)', 'We', 'It']
    '''
...
def main():
    ...
    custom_stop_words = ['Tell', 'Tell us', 'Narrated', 'Messenger', 'Prophet','And', 'Aisha', 'Division', 'Allah', 'God',
